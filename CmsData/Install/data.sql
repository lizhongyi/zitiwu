...
INSERT INTO `sgcorp_ad` (`id`, `title`, `category_id`, `title_style`, `title_style_serialize`, `ad_type`, `link_url`, `description`, `code_body`, `height`, `width`, `text_body`, `font_size`, `attach_file`, `attach_ext`, `attach_alt`, `display_order`, `status`, `create_time`, `update_time`) VALUES(1, 'test1', 33, 'color:#800080;font-weight:bold;TEXT-DECORATION: underline', 'a:3:{s:5:"color";s:7:"#800080";s:4:"bold";s:4:"bold";s:9:"underline";s:9:"underline";}', 'image', 'http://www.YIGECMS.cn', 'test', 'test', 0, 0, '', '12px', 'Ad/4b89c936da4e9.jpg', '', 'test', 0, 0, 1267282184, 1267324636);
INSERT INTO `sgcorp_ad` (`id`, `title`, `category_id`, `title_style`, `title_style_serialize`, `ad_type`, `link_url`, `description`, `code_body`, `height`, `width`, `text_body`, `font_size`, `attach_file`, `attach_ext`, `attach_alt`, `display_order`, `status`, `create_time`, `update_time`) VALUES(2, 'test2', 33, '', '', 'image', 'http://www.YIGECMS.cn', '', '', 0, 0, '', '12px', 'Ad/4b89c945afdab.jpg', '', '', 0, 0, 1267321157, 0);
INSERT INTO `sgcorp_ad` (`id`, `title`, `category_id`, `title_style`, `title_style_serialize`, `ad_type`, `link_url`, `description`, `code_body`, `height`, `width`, `text_body`, `font_size`, `attach_file`, `attach_ext`, `attach_alt`, `display_order`, `status`, `create_time`, `update_time`) VALUES(3, 'test3', 33, '', '', 'image', 'http://www.YIGECMS.cn', '', '', 0, 0, '', '12px', 'Ad/4b89c96059ba3.jpg', '', '', 0, 0, 1267321184, 1267793689);
...
INSERT INTO `sgcorp_job` (`id`, `user_id`, `title`, `title_style`, `title_style_serialize`, `keyword`, `number`, `description`, `content`, `template`, `tags`, `copy_from`, `from_link`, `link_url`, `status`, `time_type`, `end_time`, `attach_file`, `istop`, `view_count`, `display_order`, `create_time`, `update_time`) VALUES(4, 1, '新概念英语教师', 'font-weight:bold', 'a:1:{s:4:"bold";s:4:"bold";}', '', 0, '产品要求1.本科以上学历，有特殊才能者条件可适当放宽  \r\n2.英语基础扎实，发音标准，口语流利，有较强的听说读写译能力  \r\n3.性格开朗外向，赋予朝气和活力 \r\n4.具有较强的幽默感，课堂气氛生动活泼', '<p>产品要求1.本科以上学历，有特殊才能者条件可适当放宽&nbsp; <br />\r\n2.英语基础扎实，发音标准，口语流利，有较强的听说读写译能力&nbsp; <br />\r\n3.性格开朗外向，赋予朝气和活力 <br />\r\n4.具有较强的幽默感，课堂气氛生动活泼&nbsp; <br />\r\n5..有口语教学经验可优先考虑&nbsp;&nbsp; <br />\r\n薪金待遇: <br />\r\n基础工资&nbsp;+各项岗位补贴\\奖金&nbsp;+保险（养老保险&nbsp;&nbsp;医疗保险&nbsp;&nbsp;失业保险&nbsp;&nbsp;工伤保险&nbsp;&nbsp;生育保险）1000-3000元\\月</p>', '', '', '', '', '', 0, 1, 2010, '', 0, 0, 0, 1266940800, 0);
...
INSERT INTO `sgcorp_link` (`id`, `title`, `title_style`, `title_style_serialize`, `category_id`, `link_type`, `link_url`, `description`, `attach_image`, `status`, `display_order`, `create_time`, `update_time`) VALUES(1, 'YIGECMS', 'color:#ff0000;font-weight:bold', 'a:2:{s:5:"color";s:7:"#ff0000";s:4:"bold";s:4:"bold";}', 1, 'text', 'http://www.YIGECMS.cn', '', '', 0, 0, 1266392534, 0);
...
INSERT INTO `sgcorp_menu` (`id`, `title`, `title_style`, `title_style_serialize`, `parent_id`, `link_url`, `target`, `display_order`, `status`, `create_time`, `update_time`) VALUES(1, 'YIGECMS', '', '', 0, 'http://www.YIGECMS.cn', '_blank', 0, 0, 1267540911, 1267541659);
...
INSERT INTO `sgcorp_module` (`id`, `module_title`, `module_name`, `module_permission`, `system_module`, `left_menu`, `developer`, `build_version`, `display_order`, `status`, `create_time`, `update_time`) VALUES(31, '模板风格', 'Theme', '管理=Theme', 1, 0, 'developer:YIGECMS\r\nweb:http://www.YIGECMS.cn', '2.0', 0, 0, 0, 0);
INSERT INTO `sgcorp_module` (`id`, `module_title`, `module_name`, `module_permission`, `system_module`, `left_menu`, `developer`, `build_version`, `display_order`, `status`, `create_time`, `update_time`) VALUES(30, '角色管理', 'AdminRole', '浏览=AdminRole_index|录入=AdminRole_insert|编辑=AdminRole_modify|批量操作=AdminRole_command', 1, 0, 'developer:YIGECMS\r\nweb:http://www.YIGECMS.cn', '2.0', 0, 0, 0, 0);
INSERT INTO `sgcorp_module` (`id`, `module_title`, `module_name`, `module_permission`, `system_module`, `left_menu`, `developer`, `build_version`, `display_order`, `status`, `create_time`, `update_time`) VALUES(32, '模块管理', 'Module', '浏览=Module_index|编辑=Module_modify|安装=Module_install|卸载=Module_uninstall', 1, 0, 'developer:YIGECMS\r\nweb:http://www.YIGECMS.cn', '2.0', 0, 0, 0, 0);
INSERT INTO `sgcorp_module` (`id`, `module_title`, `module_name`, `module_permission`, `system_module`, `left_menu`, `developer`, `build_version`, `display_order`, `status`, `create_time`, `update_time`) VALUES(33, '系统配置', 'Config', '浏览系统配置=Config_index|编辑系统配置=Config_modify|浏览核心配置=Config_core|编辑核心配置=Config_coreModify', 1, 0, 'developer:YIGECMS\r\nweb:http://www.YIGECMS.cn', '2.0', 0, 0, 0, 0);
INSERT INTO `sgcorp_module` (`id`, `module_title`, `module_name`, `module_permission`, `system_module`, `left_menu`, `developer`, `build_version`, `display_order`, `status`, `create_time`, `update_time`) VALUES(34, '数据库管理', 'Database', '浏览=Database_index|执行SQL=Database_query|备份数据库=Database_export|恢复数据库=Database_import', 1, 0, 'developer:YIGECMS\r\nweb:http://www.YIGECMS.cn', '2.0', 0, 0, 0, 0);
INSERT INTO `sgcorp_module` (`id`, `module_title`, `module_name`, `module_permission`, `system_module`, `left_menu`, `developer`, `build_version`, `display_order`, `status`, `create_time`, `update_time`) VALUES(35, '操作日志管理', 'AdminLog', '管理=AdminLog', 1, 0, 'developer:YIGECMS\r\nweb:http://www.YIGECMS.cn', '2.0', 0, 0, 0, 0);
INSERT INTO `sgcorp_module` (`id`, `module_title`, `module_name`, `module_permission`, `system_module`, `left_menu`, `developer`, `build_version`, `display_order`, `status`, `create_time`, `update_time`) VALUES(36, '工具箱管理', 'Tools', '管理=Tools', 1, 0, 'developer:YIGECMS\r\nweb:http://www.YIGECMS.cn', '2.0', 0, 0, 0, 0);
INSERT INTO `sgcorp_module` (`id`, `module_title`, `module_name`, `module_permission`, `system_module`, `left_menu`, `developer`, `build_version`, `display_order`, `status`, `create_time`, `update_time`) VALUES(37, '数据调用', 'Label', '管理=Label', 1, 0, 'developer:YIGECMS', '', 0, 0, 0, 0);
