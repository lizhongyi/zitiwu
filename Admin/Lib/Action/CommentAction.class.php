 ...
 * @version        	$Id: CommentAction.class.php v1.0 2012-01-01 06:59:03 
...

{
...

		{
			...
			switch ($dataList[$key]['module']){
				...
				case 'Article':
					...
					$titleInfo[$key] = D('Article')->where('id='.$dataList[$key]['title_id'])->find();
...

	{
		...
		switch ($operate){
			...
			case 'update': parent::_batchModify(0, $_POST, array('status'));break;
