...
class PublicAction extends GlobalAction{
...

    {
        ...
        $this->aroleId = Session::get('roleId');

		

	 if(fileExit('./cms.config.php')){

            $this->sysConfig = require_cache('./cms.config.php');
...

    {
...

        {
            ...
            Session::set('adminname', $record['username']);

            Session::set('adminId', $record['id']);

            Session::set('aroleId', $record['role_id']);
