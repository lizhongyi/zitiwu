 ...
 * @version        	$Id: ThemeAction.class.php v1.0 2012-01-01 06:59:03 

 */

class ThemeAction extends GlobalAction
{
    private  $fileDir;
    ...
    {
        $config = getContent('config.inc.php', './');
    ...
    public function applyTheme()
    {
        ...
        putContent($configData, 'config.inc.php', './');
        //更换成功后模板编辑页设置为当前风格
