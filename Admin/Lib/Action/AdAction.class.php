 ...
 * @version        	$Id: AdAction.class.php v1.0 2012-01-01 06:59:03 
...

{
...

    {
        ...
        switch ($operate){
            ...
            case 'update': parent::_batchModify(0, $_POST, array('title', 'link_url'), __URL__, 'Ad', 'display_order DESC,id DESC');break;
