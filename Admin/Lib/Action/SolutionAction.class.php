...

{
...

    {
        ...
        $dataList = $this->dao->Table(C('DB_PREFIX').'Solution a')->Join(C('DB_PREFIX').'category b on a.category_id=b.id')->Field('a.*,b.title as category')->Order($setOrder)->Where($condition)->Limit($p->firstRow.','.$p->listRows)->select();
...

    {
        ...
        parent::_checkPermission('Solution_insert');
...

    {
        ...
        parent::_checkPermission('Solution_modify');
...

    {
        ...
        parent::_checkPermission('Solution_command');
