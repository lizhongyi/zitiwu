...
<div class="mainarea">
<div class="maininner">
<form method="post" action="<?php echo U("Product/doInsert");?>"  enctype="multipart/form-data"  id="mainFrom">
	<div class="body_content">
		<div class="top_action"><a href="__URL__">返回列表</a> | <a href="<?php echo U("Category/index");?>">类别管理</a></div>
...
只能填写数字(单位:元)</td></tr>
        ...
        <tr>
		  <th colspan="2" >
		  <textarea name="content" cols="50" rows="4" id="content_1" style="width:750px; height:300px;"><?php echo ($vo["content"]); ?></textarea>
