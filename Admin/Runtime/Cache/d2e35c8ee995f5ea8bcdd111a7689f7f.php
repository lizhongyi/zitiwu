...
*/
    ...
    <div class="top_action"><a href="<?php echo U("Product/insert");?>">录入产品</a> | <a href="<?php echo U("Product/order");?>">订单管理</a> | <a href="<?php echo U("Category/index");?>">类别管理</a></div>
	<table cellspacing="0" cellpadding="0"  id="maintable" class="formtable">
		<tr>
        <th width="6%" class="th-id">ID</th>
		 <th width="49%" >名称</th>
             
              <th width="10%" style="width:20%">类别名称</th>
              <th width="27%" style="width:12%">录入时间</th>
		<th>操作</th>
		</tr>
		...
		<td> <a href="<?php echo U('Product/modify',array('id'=>$vo['id']));?>"><img src="__PUBLIC__/Admin/modify22px.gif" alt="编辑" align="absmiddle" /></a><a href="<?php echo U('Product/delete',array('id'=>$vo['id']));?>"><img src="__PUBLIC__/Admin/delete.gif" alt="删除" align="absmiddle" /></a></td>
