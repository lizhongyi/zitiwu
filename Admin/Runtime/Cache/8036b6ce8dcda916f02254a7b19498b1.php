...
<style>.maininner{}</style>
<div class="mainarea">
	<div class="maininner">
		<div class="body_content" style="padding:15px;">
			<div class="title">
			  <h3>管理备忘录(最多2000}字)</h3></div>
			<div >
            <textarea name="notepad" id="notepad" style="width:500px; height:100px" onblur="updateNotepad()"><?php echo ($notepad["notepad"]); ?></textarea>
         <div id="msg"></div> </div>
			<br />
             <div class="title">
				<h3>版本信息</h3>
            ...
            <div>
            当前系统版本：<?php echo ($sys_version); ?>
            </div>
            <div id="sgcms" style="line-height:1.5em;"></div><br />
