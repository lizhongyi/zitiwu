    ...
    <span style=" font-weight:bold"><label for="market_price">市 场 价</label></span>
      ...
      只能填写数字(单位:元)</td></tr>
        ...
        <tr>
          ...
          <td> <input name="attach_file" type="file" id="attach_file" /><?php if(($vo['attach']) == "1"): ?>不更换请不要选择新图片　<a href="__ROOT__/<?php echo ($UPLOADS); echo ($vo["attach_image"]); ?>" target="_blank"><img src="__PUBLIC__/Admin/image.gif" border="0" align="absmiddle" /></a><?php endif; ?></td></tr>
         <tr>
        ...
        <tr>
		  <th colspan="2" >
		   <textarea name="content" cols="50" rows="4" id="content_1"  style="width:750px; height:360px;"><?php echo ($vo["content"]); ?></textarea>
</th>
		</tr>
...
<tr>
           ...
           <td><input name="template" id="template" value="<?php echo ($vo["template"]); ?>" /><input type="hidden" id="html_url" value="<?php echo ($vo["html_url"]); ?>" name="html_url"/></td>
         </tr>
        <tr>
