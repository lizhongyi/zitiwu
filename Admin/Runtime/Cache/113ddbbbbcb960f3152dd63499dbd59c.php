...
<script type="text/javascript">
	...
	<div class="body_content">
		...
		<td><input name="title" id="title" value="<?php echo ($vo["title"]); ?>"></td></tr> <tr>
		  <th style="width:12em;">分类标志</th>
		<td><input name="biaozhi" id="biaozhi" value="<?php echo ($vo["biaozhi"]); ?>">(英文或拼音)</td></tr>
		<tr>
		<tr>
        ...
        <tr>
          ...
          <?php if(is_array($module)): $i = 0; $__LIST__ = $module;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$row): $mod = ($i % 2 );++$i;?><option value="<?php echo ($row["module_name"]); ?>" <?php if(($row['module_name']) != ""): echo (selected($row["module_name"],$vo['module'])); endif; ?>><?php echo ($row["module_title"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
		  </select></td>
		  </tr>
           </tbody>
		<tr>
		  <th style="width:12em;">关 键 字</th>
		  <td><input name="keyword" class="input"id="keyword" value="<?php echo ($vo["keyword"]); ?>" /></td>
		  </tr>
		<tr>
