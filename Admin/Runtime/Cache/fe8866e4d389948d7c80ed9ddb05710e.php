...
<div class="mainarea">
<div class="maininner">
<form method="post" action="<?php echo U("Article/doModify",array('jump'=>$_GET['jump']));?>" enctype="multipart/form-data" id="mainFrom">
	<div class="body_content">
		<div class="top_action"><a href="__URL__">浏览文章</a> | <a href="<?php echo U("Article/insert");?>">录入文章</a> | <a href="<?php echo U("Category/index");?>">分类管理</a></div>
		...
		<?php if(($vo['attach']) == "1"): ?>不更换请不要选择新图片　<a href="__ROOT__/<?php echo ($UPLOADS); echo ($vo["attach_image"]); ?>" target="_blank"><img src="__PUBLIC__/Admin/image.gif" border="0" align="absmiddle" /></a>　<input name="deleteImage" type="radio" value="1" />转换为普通文章<?php endif; ?></td></tr>
         <tr>
...
<textarea name="content" cols="50" rows="4" id="content_1" style="width:720px; height:300px;"><?php echo ($vo["content"]); ?></textarea>
        ...
        <tr>
           ...
           <td><input name="template" id="template" value="<?php echo ($vo["template"]); ?>" /><input type="hidden1" id="html_url" value="<?php echo ($vo["html_url"]); ?>" name="html_url"/></td>
         </tr>
        <tr>
